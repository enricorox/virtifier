...
# tf Graph input
x = tf.compat.v1.placeholder("float", [None, seq_max_len, 20])
...
weights = {
    ...
    'out': tf.Variable(tf.compat.v1.random_normal([2 * n_hidden, n_classes]))
}
biases = {
...
def dynamicRNN(x, seqlen, weights, biases):
    lstm_cell = tf.rnn.BasicLSTMCell(n_hidden)
